//
// Created by alexkrudu on 30.10.2020.
//

#ifndef SIGNAL_INTRUSIVE_LIST_H
#define SIGNAL_INTRUSIVE_LIST_H
...
namespace intrusive {
    ...
    struct list_element : private list_element_base {
        ...
        */
        ...
        void insert(list_element &elem) {
            list_element_base::insert(elem);
        }
    ...
    */
    ...
    struct list {
        ...
        */
        ...
        iterator as_iterator(T &elem) noexcept;
...
template<typename T, typename Tag>
typename intrusive::list<T, Tag>::iterator intrusive::list<T, Tag>::as_iterator(T &elem) noexcept {
    list_element_base& base = to_base<Tag>(elem);
    return iterator(&base);
}

#endif //SIGNAL_INTRUSIVE_LIST_H
